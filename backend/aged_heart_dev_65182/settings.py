"""
Django settings for aged_heart_dev_65182 project.
...
ROOT_URLCONF = 'aged_heart_dev_65182.urls'
...
WSGI_APPLICATION = 'aged_heart_dev_65182.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_heart_dev_65182 API",
    "DESCRIPTION": "API documentation for aged_heart_dev_65182 App",
    "VERSION": "v1",
}
